# Workshop Root Flattening Implementation Plan
...
- [ ] **Step 1: Move non-colliding files with Git-aware renames**
...
- [ ] **Step 2: Merge the installer guide into the existing README**
...
- [ ] **Step 3: Update repository ignores and remove obsolete paths**
...
- [ ] **Step 1: Update the workflow and documentation paths**
...
- [ ] **Step 2: Integrate repository gates**
...
- [ ] **Step 3: Record the release-facing change**
...
- [ ] **Step 4: Remove duplicate stale code only when path migration requires it**
...
- [ ] **Step 1: Run the structural test before the flattening implementation**

The initial run must fail for the expected missing-root/stale-tree reason.

- [ ] **Step 2: Run the structural test after implementation**

Run: `bash tests/test-root-workshop-layout.sh`

Expected: `root layout PASS` and exit 0.

- [ ] **Step 3: Run the Workshop harness and syntax/lint checks**
...
- [ ] **Step 4: Run the repository Makefile and YAML gates**
...
- [ ] **Step 5: Inspect the final diff and verify no real runtime state changed**
